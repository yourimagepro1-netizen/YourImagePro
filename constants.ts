...
export const STYLE_OPTIONS: StyleOption[] = [
  ...
  { id: 'environmental_portrait_wide', name: 'Environmental Portrait (Wide)', thumbnail: '...', color: 'bg-emerald-800', category: 'professional_headshots', requiredPlan: 'free', excludeFromRandom: true },
  ...
  { id: 'product_lifestyle_shoot_wide', name: 'Product Lifestyle (Wide)', thumbnail: '...', color: 'bg-cyan-700', category: 'branding_marketing', requiredPlan: 'free', excludeFromRandom: true },
  ...
  { id: 'brand_narrative_cinematic', name: 'Brand Narrative (Cinematic)', thumbnail: '...', color: 'bg-slate-700', category: 'branding_marketing', requiredPlan: 'free', excludeFromRandom: true },
  ...
  { id: 'travel_blogger_wide', name: 'Travel Blogger (Wide)', thumbnail: '...', color: 'bg-sky-700', category: 'lifestyle_editorial', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'weekend_getaway_wide', name: 'Weekend Getaway (Wide)', thumbnail: '...', color: 'bg-green-700', category: 'lifestyle_editorial', requiredPlan: 'free', excludeFromRandom: true },
  ...
  { id: 'surrealist_dreamscape_wide', name: 'Surrealist Dreamscape (Wide)', thumbnail: '...', color: 'bg-purple-900', category: 'creative_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'cyberpunk_cityscape_wide', name: 'Cyberpunk Cityscape (Wide)', thumbnail: '...', color: 'bg-pink-900', category: 'creative_portraits', requiredPlan: 'free', excludeFromRandom: true },
  ...
  { id: 'vogue_editorial_spread_wide', name: 'Vogue Editorial (Wide)', thumbnail: '...', color: 'bg-neutral-800', category: 'model_photoshoots', requiredPlan: 'free', excludeFromRandom: true },
  ...
  // --- Seasonal & Holiday ---
  { id: 'birthday_celebration', name: 'Birthday Celebration', thumbnail: '...', color: 'bg-pink-600', category: 'seasonal', requiredPlan: 'free' },
  { id: 'christmas_portrait', name: 'Christmas Portrait', thumbnail: '...', color: 'bg-emerald-700', category: 'seasonal', requiredPlan: 'free' },
  { id: 'new_years_eve_party', name: 'New Year\'s Eve', thumbnail: '...', color: 'bg-yellow-700', category: 'seasonal', requiredPlan: 'free' },
  { id: 'valentines_day', name: 'Valentine\'s Day', thumbnail: '...', color: 'bg-red-600', category: 'seasonal', requiredPlan: 'free' },
  { id: 'st_patricks_day_fun', name: 'St. Patrick\'s Day', thumbnail: '...', color: 'bg-green-600', category: 'seasonal', requiredPlan: 'free' },
  { id: 'easter_photo', name: 'Easter Photo', thumbnail: '...', color: 'bg-violet-400', category: 'seasonal', requiredPlan: 'free' },
  { id: 'july_4th_celebration', name: '4th of July', thumbnail: '...', color: 'bg-blue-700', category: 'seasonal', requiredPlan: 'free' },
  { id: 'halloween_costume', name: 'Halloween Costume', thumbnail: '...', color: 'bg-orange-600', category: 'seasonal', requiredPlan: 'free' },
  { id: 'thanksgiving_gathering', name: 'Thanksgiving', thumbnail: '...', color: 'bg-amber-800', category: 'seasonal', requiredPlan: 'free' },
  { id: 'hanukkah_celebration', name: 'Hanukkah Celebration', thumbnail: '...', color: 'bg-sky-700', category: 'seasonal', requiredPlan: 'free' },
  { id: 'spring_blossoms', name: 'Spring Blossoms', thumbnail: '...', color: 'bg-pink-400', category: 'seasonal', requiredPlan: 'free' },
  { id: 'summer_beach_day', name: 'Summer Beach Day', thumbnail: '...', color: 'bg-cyan-500', category: 'seasonal', requiredPlan: 'free' },
  { id: 'autumn_leaves', name: 'Autumn Leaves', thumbnail: '...', color: 'bg-orange-700', category: 'seasonal', requiredPlan: 'free' },
  { id: 'winter_wonderland', name: 'Winter Wonderland', thumbnail: '...', color: 'bg-sky-600', category: 'seasonal', requiredPlan: 'free' },
  
  // --- Sports & Fitness ---
  { id: 'fitness_influencer', name: 'Fitness Influencer', thumbnail: '...', color: 'bg-lime-700', category: 'sports_fitness', requiredPlan: 'free' },
  { id: 'fitness_athleisure_full', name: 'Fitness & Athleisure', thumbnail: '...', color: 'bg-lime-800', category: 'sports_fitness', requiredPlan: 'free' },
  { id: 'basketball_player', name: 'Basketball Player', thumbnail: '...', color: 'bg-orange-600', category: 'sports_fitness', requiredPlan: 'free' },
  { id: 'football_player', name: 'Football Player', thumbnail: '...', color: 'bg-green-800', category: 'sports_fitness', requiredPlan: 'free' },
  { id: 'soccer_player', name: 'Soccer Player', thumbnail: '...', color: 'bg-emerald-600', category: 'sports_fitness', requiredPlan: 'free' },
  { id: 'yoga_pose', name: 'Yoga Pose', thumbnail: '...', color: 'bg-teal-600', category: 'sports_fitness', requiredPlan: 'free' },
  { id: 'sports_team_portrait', name: 'Sports Team Portrait', thumbnail: '...', color: 'bg-red-800', category: 'sports_fitness', requiredPlan: 'free', excludeFromRandom: true },

  // --- Group Portraits (Family, Friends, Teams) ---
  { id: 'family_beach_portrait', name: 'Family Beach Portrait', thumbnail: '...', color: 'bg-sky-600', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'romantic_couple_paris', name: 'Romantic in Paris', thumbnail: '...', color: 'bg-rose-500', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'cozy_family_at_home', name: 'Cozy Family at Home', thumbnail: '...', color: 'bg-amber-700', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'formal_family_studio', name: 'Formal Studio Portrait', thumbnail: '...', color: 'bg-slate-700', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'adventurous_couple_hiking', name: 'Adventurous Couple Hiking', thumbnail: '...', color: 'bg-emerald-700', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'urban_couple_street_style', name: 'Urban Couple Street Style', thumbnail: '...', color: 'bg-neutral-800', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'corporate_team_photo', name: 'Corporate Team Photo', thumbnail: '...', color: 'bg-blue-800', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'startup_team_casual', name: 'Startup Team (Casual)', thumbnail: '...', color: 'bg-indigo-700', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'friends_night_out', name: 'Friends\' Night Out', thumbnail: '...', color: 'bg-purple-700', category: 'couples_family_portraits', requiredPlan: 'free', excludeFromRandom: true },

  // --- Memorial & Remembrance ---
  { id: 'together_again', name: 'Together Again', thumbnail: '...', color: 'bg-gray-500', category: 'memorial_remembrance', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'guardian_angel', name: 'Guardian Angel', thumbnail: '...', color: 'bg-amber-400', category: 'memorial_remembrance', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'shared_moment', name: 'A Shared Moment', thumbnail: '...', color: 'bg-sky-400', category: 'memorial_remembrance', requiredPlan: 'free', excludeFromRandom: true },
  { id: 'in_loving_memory', name: 'In Loving Memory', thumbnail: '...', color: 'bg-stone-500', category: 'memorial_remembrance', requiredPlan: 'free', excludeFromRandom: true },
];

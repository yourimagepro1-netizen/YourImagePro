...
export interface StyleOption {
  ...
  thumbnail: string;
  color: string;
  category: 'professional_headshots' | 'branding_marketing' | 'lifestyle_editorial' | 'creative_portraits' | 'model_photoshoots' | 'couples_family_portraits' | 'urban_hip' | 'seasonal' | 'sports_fitness' | 'memorial_remembrance';

...
const getStyleInstruction = (style: StyleOption, isGroup: boolean = false): string => {
      const groupContext = isGroup ? "This is a group photo. Adapt the style for multiple subjects interacting naturally." : "This is a solo portrait.";
      ...
      switch (style.id) {
        ...
        case 'birthday_celebration':
            return `A joyful and vibrant birthday celebration photo. ${isGroup ? "The subjects are" : "The subject is"} the center of attention, smiling and happy. The scene is festive, filled with balloons, confetti, and perhaps a birthday cake with candles. The lighting is bright and celebratory. The mood is pure happiness and fun.`;
        case 'christmas_portrait':
            return `A warm and cozy Christmas portrait. ${isGroup ? "The subjects are wearing festive attire, like ugly Christmas sweaters or coordinated outfits, and are gathered" : "The subject is wearing festive attire and is"} in a festively decorated living room with a decorated Christmas tree and warm, glowing lights in the background. The mood is joyful, loving, and full of holiday spirit.`;
        case 'new_years_eve_party':
            return `A glamorous and celebratory photo from a New Year's Eve party. ${isGroup ? "The subjects are" : "The subject is"} dressed in formal or festive party attire. The scene is full of energy, with confetti falling, champagne glasses, and a backdrop suggesting a countdown to midnight (like a clock or city skyline). The mood is exciting, hopeful, and full of celebration.`;
        case 'valentines_day':
            return `A romantic and sweet Valentine's Day photo. ${isGroup ? "The couple is in a beautiful, intimate setting, perhaps a candlelit dinner. " : "The subject is in a beautiful, romantic setting with hearts and flowers subtly in the background."} The mood is loving and affectionate. Attire is stylish and romantic.`;
        case 'st_patricks_day_fun':
            return `A fun and festive photo celebrating St. Patrick's Day. ${isGroup ? "The subjects are" : "The subject is"} wearing green, perhaps with silly hats or accessories. The setting is a lively Irish pub or a parade. The mood is cheerful and energetic.`;
        case 'easter_photo':
            return `A bright and cheerful Easter photo. ${isGroup ? "The subjects are" : "The subject is"} dressed in their Sunday best, with pastel colors. The setting is a beautiful spring garden or a decorated porch. There might be Easter baskets or decorated eggs as props. The lighting is soft and natural.`;
        case 'july_4th_celebration':
            return `A patriotic and fun 4th of July celebration photo. ${isGroup ? "The subjects are" : "The subject is"} dressed in red, white, and blue. The setting is a classic American barbecue, a picnic, or watching fireworks at dusk. The mood is celebratory and summery.`;
        case 'halloween_costume':
            return `A spooky and fun Halloween photo. ${isGroup ? "The subjects are" : "The subject is"} in a creative costume. The setting is a decorated Halloween party with pumpkins, cobwebs, and moody lighting. The mood is playful and mysterious.`;
        case 'thanksgiving_gathering':
            return `A warm and inviting photo of a Thanksgiving gathering. ${isGroup ? "They are gathered around a dinner table laden with food, or relaxing in a cozy living room." : "The subject is in a cozy, autumnal setting, perhaps near a fireplace or a table with Thanksgiving decorations."} The colors are warm and autumnal. The mood is grateful and full of togetherness.`;
        case 'hanukkah_celebration':
            return `A beautiful and warm photo celebrating Hanukkah. ${isGroup ? "The family is" : "The person is"} gathered around a lit menorah. The lighting is soft and glowing, coming from the candles. The mood is peaceful, spiritual, and full of family love.`;
        case 'spring_blossoms':
            return "A beautiful portrait set in a park or garden full of blooming spring flowers, like cherry blossoms. The subject is enjoying the beautiful day. Lighting is soft and bright.";
        case 'summer_beach_day':
            return "A vibrant and sunny photo on a beautiful beach. The subject is enjoying the summer day, with clear blue skies and ocean in the background.";
        case 'autumn_leaves':
            return "A cozy portrait taken in a park or forest during autumn. The scene is filled with warm-colored fall leaves on the trees and ground. The subject wears a sweater or jacket.";
        case 'winter_wonderland':
            return "A magical winter portrait in a snowy landscape. The scene could be a snowy forest or a cozy town square. The subject is dressed warmly. The mood is peaceful and serene.";
        ...
        case 'basketball_player':
            return "A dynamic action shot of a basketball player on a court. They are wearing a basketball uniform and are in the middle of a play, like dribbling or shooting. The lighting is dramatic, like in a professional arena.";
        case 'football_player':
            return "A powerful portrait of an American football player on a field. They are wearing a full uniform and helmet. The mood is intense and focused, with dramatic stadium lighting.";
        case 'soccer_player':
            return "An action shot of a soccer player on a grassy field. They are wearing a team uniform and are captured dribbling or kicking the ball. The lighting is bright and energetic.";
        case 'yoga_pose':
            return "A serene and graceful photo of a person performing a yoga pose. The setting is a calm and peaceful location, like a minimalist studio, a beach at sunrise, or a beautiful garden. The lighting is soft and natural.";
        ...
        case 'together_again':
          return "Create a gentle, respectful, and photorealistic portrait of the two people provided. They should be standing naturally side-by-side or with a gentle arm around each other. The mood must be peaceful, loving, and serene, like a cherished memory. The background should be simple and soft-focused, such as a neutral professional photography studio, a peaceful garden, or a calm sky. The final image should feel warm and timeless.";
        case 'guardian_angel':
          return "Create a symbolic and beautiful image with an ethereal quality. The main subject (from the first photo) should be clear and in focus, looking content or thoughtful. The second person (from the second photo) should appear as a gentle, loving, guardian angel presence. This can be achieved by making them slightly transparent, surrounding them with a soft, warm light, or having them fade softly into the background. The overall tone is comforting, spiritual, and deeply respectful.";
        case 'shared_moment':
          return "Create a beautiful, scenic environmental portrait of the two people together in a peaceful, idyllic location. Examples include a serene beach at sunset, sitting on a park bench under autumn trees, or walking through a beautiful garden. The interaction between them should feel natural and loving. The goal is to create a beautiful, shared memory in a timeless setting. The lighting should be soft and warm (like the golden hour).";
        case 'in_loving_memory':
          return "Create a classic and elegant tribute portrait. The composition must be respectful and loving. This style often incorporates a space for remembrance. For instance, the two individuals could be standing together, or one person could be looking at a beautifully framed photo of the other. Crucially, compose the image with a clean area or banner (often at the bottom) where text such as a name and dates could be added later by the user without covering the subjects. The background should be simple and non-distracting, like a studio backdrop or a subtle gradient.";

        default:
          return `Apply a professional, realistic, and high-quality '${style.name}' style to the image. Ensure the composition and lighting are executed to a studio-quality standard. ${groupContext}`;
      }
};
...
- **ABSOLUTE PRIORITY:** The success of this task is 100% dependent on the perfect, identical recreation of each person's face. This is not an artistic interpretation of the face; it is a technical replication.`
    ...
    if (options.customPrompt) {
        ...
        styleInstruction = getStyleInstruction(options.style, true);
    } else {
...
export const generateAdCreative = async (
  ...
  try {
    ...
    if (options.subjectPhotos && options.subjectPhotos.length > 0) {
      for (const file of options.subjectPhotos) {
        const base64SubjectData = await fileToBase64(file);
        imageParts.push({
          inlineData: {
            data: base64SubjectData,
            mimeType: file.type
          }
        });
      }
    ...
    const subjectPhotosInstruction = options.subjectPhotos && options.subjectPhotos.length > 0
      ? `You have been provided with ${options.subjectPhotos.length} photo(s) of people who are the subjects/hosts of the event. You MUST incorporate these people into the flyer's design in a natural and professional way. **CRITICAL: You must preserve their facial features and identity with 100% accuracy.** Do not change who they are. Integrate them into the scene according to the visual style.`
      : "No photos of people were provided. The design should be illustrative or abstract based on the style description.";
...
**Asset Integration:**
- **Subject Photos:** ${subjectPhotosInstruction}
- **Logo:** ${logoInstruction}

**Step-by-Step Generation Process:**
1.  **Analyze Assets:** Review the style description, text content, and any provided subject photos or logos.
2.  **Create Scene:** Generate a beautiful, high-quality background image that perfectly matches the 'Visual Style' description and creates a cohesive environment for the subject photos (if provided). This background MUST NOT contain any text.
3.  **Composite Elements:** Place the subjects from the photos into the scene. Then, overlay the text elements and logo. Ensure everything is readable, well-placed, and follows graphic design principles (hierarchy, alignment, contrast).
4.  **Final Output:** The final output must be a single, complete flyer image with the background, subjects, text, and logo all integrated, conforming to the ${options.aspectRatio} aspect ratio.

**Negative Constraints:** Do not add any text that wasn't provided in the 'Text Content' section. Do not distort the logo or the faces of the subjects. Ensure all text is spelled correctly as provided. The output must be ONLY the final flyer image.
`,
    };

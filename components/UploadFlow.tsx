...
type Category = 'professional_headshots' | 'branding_marketing' | 'lifestyle_editorial' | 'creative_portraits' | 'model_photoshoots' | 'urban_hip' | 'seasonal' | 'sports_fitness' | 'couples_family_portraits';
...
const UploadFlow: React.FC<UploadFlowProps> = ({ user, onGenerate, onGenerateRandom, onNavigateToPricing, initialRequest, generationCost, onWatchAd, onNavigateToCustomPrompt }) => {
  ...
  const getCategoryIcon = (category: Category) => {
    ...
    switch (category) {
        ...
        case 'sports_fitness': return <ZapIcon {...props} />; // Placeholder, consider a better icon
